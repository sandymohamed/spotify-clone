...
const UploadModal = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (values) => {
        console.log(values);
        // TODO: send data to supabase and refresh page
        ...
        <Modal
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-y-4" >
                ...
                <div>
                    ...
                    <Input id="song" type="file" disabled={isLoading} accept=".mp3" {...register('song', { required: true })} placeholder="Song author" />
                ...
                <div>
                    ...
                    <Input id="image" type="file" disabled={isLoading} accept="image/*" {...register('image', { required: true })} placeholder="Song author" />
                </div>
